...
namespace GraphAlgoritms.Modules.Graph.ViewModels
{
    public partial class GraphViewModel
    {
        ...
        {
            private abstract class GraphTraversalAlgoritmCreator : AlgoritmCommandCreator<GraphTraversalAlgoritmInfo>
            {

                public GraphTraversalAlgoritmCreator(GraphViewModel graphVM) 
                    : base(graphVM) { }
